...
if http:
    ...
    class HealthController(http.Controller):  # type: ignore[misc]
        @http.route("/api/health", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def health(self, **kw):  # noqa: ANN001
            return health_payload()

        @http.route("/api", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def api_root(self, **kw):  # noqa: ANN001
            return api_root_payload()

    class SysController(http.Controller):  # type: ignore[misc]
        @http.route("/api/sys/feature-status", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def feature_status(self, **kw):  # noqa: ANN001
            return feature_status_payload()

        @http.route("/api/sys/org", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def org(self, **kw):  # noqa: ANN001
            return sys_admin_service.org_tree()

        @http.route("/api/sys/org", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/org/<int:org_id>", type="json", methods=["PUT"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/org/<int:org_id>", type="http", methods=["DELETE"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/user", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def user_list(self, **kw):  # noqa: ANN001
            return sys_admin_service.user_list()

        @http.route("/api/sys/user", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/user/<int:user_id>", type="json", methods=["PUT"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/my-menu", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/all-menus", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def all_menus(self, **kw):  # noqa: ANN001
            return sys_admin_service.all_menus()

        @http.route("/api/sys/role", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def roles(self, **kw):  # noqa: ANN001
            return sys_admin_service.roles_summary()

        @http.route("/api/sys/role/<string:code>/menus", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def role_menus(self, code, **kw):  # noqa: ANN001
            return sys_admin_service.role_menus(str(code))

        @http.route("/api/sys/role/<string:code>/menus", type="json", methods=["PUT"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def role_menus_save(self, code, paths=None, **kw):  # noqa: ANN001
            return sys_admin_service.role_menus_save(str(code), list(paths or []))

        @http.route("/api/sys/role/<string:code>/permissions", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def role_permissions(self, code, **kw):  # noqa: ANN001
            return sys_admin_service.role_permissions(str(code))

        @http.route("/api/sys/role/<string:code>/permissions", type="json", methods=["PUT"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/all-permissions", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def all_permissions(self, **kw):  # noqa: ANN001
            return sys_admin_service.all_permissions()

        @http.route("/api/sys/my-permissions", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/sys/log", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class AuthController(http.Controller):  # type: ignore[misc]
        @http.route("/api/auth/login", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/auth/worker-login", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/auth/worker-qrcode-login", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class PersonController(http.Controller):  # type: ignore[misc]
        @http.route("/api/person/archive", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/person/archive/<int:person_id>", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def archive_one(self, person_id, **kw):  # noqa: ANN001
            row = archive_get(int(person_id))
            return row or {"code": "NOT_FOUND", "message": "不存在"}

        @http.route("/api/person/archive", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def archive_create(self, **kw):  # noqa: ANN001
            try:
                new_id = archive_create(kw)
            except Exception as e:  # noqa: BLE001
                return {"code": "BAD_REQUEST", "message": str(e)}
            return {"id": new_id}

        @http.route("/api/person/archive/<int:person_id>", type="json", methods=["PUT"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def archive_update(self, person_id, **kw):  # noqa: ANN001
            try:
                ok_ = archive_update(int(person_id), kw)
            except Exception as e:  # noqa: BLE001
                return {"code": "BAD_REQUEST", "message": str(e)}
            if not ok_:
        ...
        @http.route("/api/person/archive/<int:person_id>", type="http", methods=["DELETE"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def archive_delete(self, person_id, **kw):  # noqa: ANN001
            ok_ = archive_delete(int(person_id))
            if not ok_:
                return {"code": "NOT_FOUND", "message": "人员不存在"}
            return {"ok": True}

        @http.route("/api/person/status", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def status(self, **kw):  # noqa: ANN001
            return status_counts()

        @http.route("/api/person/job-titles", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def job_titles(self, **kw):  # noqa: ANN001
            return job_titles()

    class WorkerController(http.Controller):  # type: ignore[misc]
        @http.route("/api/worker/me", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/worker/certificates", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class NotifyController(http.Controller):  # type: ignore[misc]
        @http.route("/api/notify/list", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/notify/<int:notify_id>/read", type="http", methods=["PUT"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class AttendanceController(http.Controller):  # type: ignore[misc]
        @http.route("/api/attendance/report", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/attendance/my", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/attendance/clock", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/attendance/log", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class SettlementController(http.Controller):  # type: ignore[misc]
        @http.route("/api/settlement/my-pending", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/settlement/my", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/settlement/confirm", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/settlement/generate", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/settlement/push-notify", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class ContractController(http.Controller):  # type: ignore[misc]
        @http.route("/api/contract/template", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def template_list(self, **kw):  # noqa: ANN001
            return c_template_list()

        @http.route("/api/contract/status", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        ...
        @http.route("/api/contract/my-pending", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def my_pending(self, person_id=None, **kw):  # noqa: ANN001
            pid = int(person_id or 0)
            if not pid:
        ...
        @http.route("/api/contract/my-signed", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class SiteController(http.Controller):  # type: ignore[misc]
        @http.route("/api/site/board", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def board(self, **kw):  # noqa: ANN001
            return site_board()

        @http.route("/api/site/leave", type="json", methods=["POST"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class DataController(http.Controller):  # type: ignore[misc]
        @http.route("/api/data/board", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def board(self, **kw):  # noqa: ANN001
            return data_board()

        @http.route("/api/data/board/trend", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
    ...
    class MonitorController(http.Controller):  # type: ignore[misc]
        @http.route("/api/monitor/health", type="http", methods=["GET"], auth="none", sitemap=False, csrf=False, cors="*")  # type: ignore[attr-defined]
        @render_json
        def health(self, **kw):  # noqa: ANN001
